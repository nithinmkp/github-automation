...
survey_data <- read_sheet("https://docs.google.com/spreadsheets/d/1AstWG-tYP-zLJorUrN4pjFVS4MFtznFrms3-2EMDEGc/edit?usp=sharing")
...
sum_age <-datasummary_skim(survey_data_group, type ="numeric", fun_numeric = list(N =N,Unique = NUnique,Mean = Mean, SD =
...
# Generate plots
age_plot <- create_pie_chart(survey_data, "age", "Age Group Distribution")
